...
try:
	...
	####################################
		...
		write('reflogfile.log',"wrp_009:This command calls the lin24 script")
		command = 'python ' + scr + '\\lin24 ' + hostname + ' ' + username + ' ' + password + ' ' + app_sid
	...
	####################################
		...
		write('reflogfile.log',"wrp_009:This command calls the win17 script")
		command = 'c:\\python27\\python.exe ' + scr + '\win17 ' + hostname + ' ' + username + ' ' + password + ' ' + prof_path + ' ' + scr + ' ' + ref_id
		write('reflogfile.log',command)
		command=subprocess.Popen(command,shell=True,stdout=subprocess.PIPE)
                out, err = command.communicate()
