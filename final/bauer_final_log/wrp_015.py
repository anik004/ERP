...
try:
	...
	####################################
		...
		app_sid = argv[7]
		write('reflogfile.log',"wrp_015:This command calls the lin25 script")
		command = 'python ' + scr + '\\lin25 ' + hostname + ' ' + username + ' ' + password + ' ' + app_sid 
	...
	####################################
		...
		write('reflogfile.log',"wrp_015:This command calls the win35 script")
		command = 'c:\\python27\\python.exe ' + scr + '\win35 ' + hostname + ' ' + username + ' ' + password + ' ' + prof_path + ' ' + ref_id + ' ' + scr
		write('reflogfile.log',command)
		command=subprocess.Popen(command,shell=True,stdout=subprocess.PIPE)
                out, err = command.communicate()
		print out
