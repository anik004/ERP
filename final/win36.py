...
#    	out, err = command.communicate()
		...
		write(loc.strip('\\') + '\\reflogfile.log',"win36:" + command)
		print command
		command=subprocess.Popen(command,shell=True,stdout=subprocess.PIPE)
		out, err = command.communicate()
		print out
		...
		if count1 > 3 or count1 < 3 or count2 > 3 or count2 < 3:
			...
			for name in "cofiles", "data":
				...
				write(loc.strip('\\') + '\\reflogfile.log',"win36:This command copies the file from source path to the sharefolder")
				...
				if status == 0:
					write(loc.strip('\\') + '\\reflogfile.log',"win36:This command copies the file from sharefolder to the target path")
			...
			if status == '0' or status == '4':
				write(loc.strip('\\') + '\\reflogfile.log','win36 : this command is used to do tp modbuffer')
				...
				print status
				if status == '0' or status == '4':
					write(loc.strip('\\') + '\\reflogfile.log','win36 : this command is used to do tp import')
