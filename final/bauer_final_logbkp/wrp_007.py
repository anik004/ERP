...
try:
	...
	####################################
		...
		write('reflogfile.log',"wrp_007:This command calls the lin20 script")
	...
	####################################
		...
		write('reflogfile.log',"wrp_007:This command calls the win13 script")	
		command = 'c:\\python27\\python.exe ' + path + '\win13 ' + s_path + ' ' + tr_id + ' ' + t_path + ' ' + t_host + ' ' + t_sid + ' ' + dom + ' ' + t_user + ' ' + t_passwd + ' ' + s_sid + ' ' + kernel + ' ' + ref_id + ' ' + path
		write('reflogfile.log',command)
		command=subprocess.Popen(command,shell=True,stdout=subprocess.PIPE)
                out, err = command.communicate()
		print out
