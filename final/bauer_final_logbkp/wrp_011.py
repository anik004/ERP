...
try:
	...
	####################################
		...
		write('reflogfile.log',"wrp_011:This command prints the statement")
	...
	####################################
		...
		write('reflogfile.log',"wrp_011:This command calls the win18 script")
		command = 'c:\\python27\\python.exe ' + scr + '\win18 ' + hostname + ' ' + username + ' ' + password + ' ' + prof_path + ' ' + ref_id + ' ' + scr
		write('reflogfile.log',command)
		command=subprocess.Popen(command,shell=True,stdout=subprocess.PIPE)
                out, err = command.communicate()
		print out
