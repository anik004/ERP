...
try:
	...
	####################################
		...
		write('reflogfile.log',"wrp_013:This command prints the statement")
	...
	####################################
		...
		write('reflogfile.log',"wrp_013:This command calls the win31 script")
		command = 'c:\\python27\\python.exe ' + scr + '\win31 ' + hostname + ' ' + username + ' ' + password + ' ' + prof_path + ' ' + scr + ' ' + ref_id
		write('reflogfile.log',command)
		command=subprocess.Popen(command,shell=True,stdout=subprocess.PIPE)
                out, err = command.communicate()
		print out
