...
#    	out, err = command.communicate()
	...
	write('reflogfile.log',"win33:" + command)
	command=subprocess.Popen(command,shell=True,stdout=subprocess.PIPE)
        out, err = command.communicate()
    ...
    # -------------------------------- Restore -------------------------------------------
		...
		#if status == 0:
		write('reflogfile.log',"win33:This command copies the file to the sharefolder")
		...
		write('reflogfile.log',out)
                status = command.returncode
                if status == 0:
			write('reflogfile.log',"win33:This command copies the file from sharefolder to target path")
