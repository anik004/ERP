...
try:
  ...
  for line in out:
    if re.search('DRL',line):
	    ...
	    if 'BKP' not in line:
	        ...
	        #print path
  """
  write('reflogfile.log','win10: This command is used to get the instance number of the target system')
  ...
  for line in out:
	...
	match =  match[4]
	instance = match[-2:]
        write('reflogfile.log','win10: This command is used to stop the SAP system')
	...
	status = command.returncode
     ...
     if str(e) == "[Errno -2] Name or service not known":
		...
		write('reflogfile.log','PRE:F:Please check the hostname that you have provide [Error Code - 1205]')
		...
		write('reflogfile.log','PRE:F:Host Unreachable or Unable to connect to port 22 [Error Code - 1206]')
...
#                write(logfile,'PRE:F:Unknown Error:' + str(e) + '[Error Code - 1207]')
		write('reflogfile.log','PRE:F:Unknown Error:' + str(e) + '[Error Code - 1207]')
     else:
                print "SAPSTOPAPP:F:" + str(e)
#		write(logfile,"SAPSTOPAPP:F:" + str(e)) 
		write('reflogfile.log',"SAPSTOPAPP:F:" + str(e))
