...
#	print status
	...
	if "does not exist" in out[0].strip():
		print "DB_BEGIN_MODE:F:Wrong DB sid - " + argv[4] + " has been passed. Please enter the correct DB sid"
	...
	if status == 0:
		...
		print "DB_BEGIN_MODE:F: Failed to put Source Database is in backup mode Hostname - " + host
		write(logfile,'POST:F: Failed to put Source Database is in backup mode Hostname - ' + host)

except Exception as e:
     if str(e) == "[Errno -2] Name or service not known":
                print "DB_BEGIN_MODE:F:GERR_1301:Hostname unknown"
                ...
                print "DB_BEGIN_MODE:F:GERR_1303:Authentication failed."
                write(logfile,'POST:F:Authentication failed.[Error Code - 1303]')
     elif str(e) == "[Errno 110] Connection timed out":
                print "DB_BEGIN_MODE:F:GERR_1304:Host Unreachable"
